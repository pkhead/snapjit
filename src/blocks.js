...
SyntaxElementMorph.prototype.reactToGrabOf = function (grabbedMorph) {
    ...
    affected;
    console.log("Grabbed of -- invalidate cache", topBlock);
    topBlock.compiled = null;
...
CommandBlockMorph.prototype.nextBlock = function (block) {
    ...
    if (block) {
        ...
        console.log("nextBlock invalidate", this.topBlock());
        block.compiled = null;
        this.topBlock().compiled = null;
    } else {
        return detect(
            this.children,
...
CommandSlotMorph.prototype.nestedBlock = function (block) {
    if (block) {
        let top = this.topBlock();
        console.log("nestedBlock invalidate", top);
